...
# --------------------------------------------------------------------------------
# This script is building packages for Alignak WS module thanks to the fpm
...
pkg_name="${python_prefix}-alignak-module-logs"
pkg_description="Alignak logs module for Alignak"
